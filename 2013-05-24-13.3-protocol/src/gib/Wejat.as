package gib
{
   ...
   public class Wejat extends Sprite
   {
      {
         var _loc1_:* = true;
         var _loc2_:* = false;
      ...
      public function Wejat(param1:String, param2:Boolean) {
         var _loc3_:* = false;
         var _loc4_:* = true;
         super();
         this.nameText_=new Lufub().setSize(18).setColor(11776947);
         this.nameText_.setBold(true);
         this.nameText_.setStringBuilder(new Sire().setParams(param1));
         this.nameText_.filters=[new DropShadowFilter(0,0,0)];
         addChild(this.nameText_);
         this.inputText_=new Sytubyvyg(20,11776947,true,238,30);
         ...
         graphics.endFill();
         graphics.lineStyle();
         this.inputText_.addEventListener(Event.CHANGE,this.kyqol);
      ...
      public function hivuma(param1:String, param2:Object=null) : void {
         var _loc3_:* = true;
         var _loc4_:* = false;
         this.errorText_.setStringBuilder(new Sire().setParams(param1,param2));
         return;
      }

      public function kyqol(param1:Event) : void {
         var _loc2_:* = true;
         var _loc3_:* = false;
