package moryzis
{
   ...
   public class Qyvahuh extends Particle
   {
      public function Qyvahuh(param1:int, param2:int, param3:int, param4:Point, param5:Point) {
         var _loc8_:* = true;
         var _loc9_:* = false;
      ...
      override public function update(param1:int, param2:int) : Boolean {
         ...
         map_.addObj(new Lupu(100*(z_+1),color_,600,z_,Hatuf.melemy(1),Hatuf.melemy(1)),this.pathX_,this.pathY_);
         return true;
      }
   }
