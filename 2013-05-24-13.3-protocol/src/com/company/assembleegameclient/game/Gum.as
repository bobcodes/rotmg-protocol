package com.company.assembleegameclient.game
{
   ...
   public class Gum extends Object
   {
      public function Gum() {
         var _loc1_:* = true;
         var _loc2_:* = false;
      ...
      public function addRecord(param1:int, param2:Number, param3:Number) : void {
         ...
         var _loc4_:int = this.tufu(param1);
         ...
         {
            this.records_.push(new Qiwivevih(param1,param2,param3));
            return;
         }
         var _loc5_:Qiwivevih = this.records_[this.records_.length-1];
         var _loc6_:int = this.tufu(_loc5_.time_);
         if(_loc4_!=_loc6_)
         {
            this.records_.push(new Qiwivevih(param1,param2,param3));
            return;
         }
         var _loc7_:int = this.luvavopic(_loc4_,param1);
         var _loc8_:int = this.luvavopic(_loc4_,_loc5_.time_);
         if(_loc7_<_loc8_)
         {
            _loc5_.time_=param1;
            _loc5_.x_=param2;
      ...
      private function tufu(param1:int) : int {
         var _loc2_:* = true;
         var _loc3_:* = false;
         return (param1-this.lastClearTime_+50)/100;
      }

      private function luvavopic(param1:int, param2:int) : int {
