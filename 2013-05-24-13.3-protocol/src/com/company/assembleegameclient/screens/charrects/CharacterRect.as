package com.company.assembleegameclient.screens.charrects
{
   ...
   public class CharacterRect extends Sprite
   {
      ...
      protected var taglineText:Lufub;

      protected var classNameText:Lufub;

      protected var className:Zirewe;
      ...
      protected function makeClassNameText() : void {
         this.classNameText=new Lufub().setSize(18).setColor(16777215);
      ...
      protected function makeTaglineText(param1:Zirewe) : void {
         this.taglineText=new Lufub().setSize(14).setColor(11776947);
