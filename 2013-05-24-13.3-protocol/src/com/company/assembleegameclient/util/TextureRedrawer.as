package com.company.assembleegameclient.util
{
   ...
   public class TextureRedrawer extends Object
   {
      ...
      public static const votepyvo:int = 12;

      public static const lyvem:int = 2*votepyvo;
      ...
      private static var sebiz:Dictionary = new Dictionary();
      ...
      public static function resize(param1:BitmapData, param2:BitmapData, param3:int, param4:Boolean, param5:int, param6:int, param7:Number=5) : BitmapData {
         ...
         _loc10_.translate(votepyvo,votepyvo);
         var _loc11_:BitmapData = new BitmapData(_loc8_+lyvem,_loc9_+(param4?votepyvo:1)+votepyvo,true,0);
      ...
      public static function outlineGlow(param1:BitmapData, param2:uint, param3:uint, param4:Number=1.4) : BitmapData {
         ...
         _loc5_.applyFilter(_loc5_,_loc5_.rect,PointUtil.qohusovu,OUTLINE_FILTER);
         if(param3!=4.294967295E9)
         {
            GLOW_FILTER.color=param3;
            _loc5_.applyFilter(_loc5_,_loc5_.rect,PointUtil.qohusovu,GLOW_FILTER);
         }
         return _loc5_;
      }
      ...
      public static function redrawSolidSquare(param1:uint, param2:int) : BitmapData {
         ...
         _loc4_.applyFilter(_loc4_,_loc4_.rect,PointUtil.qohusovu,OUTLINE_FILTER);
      ...
      public static function clearCache() : void {
         ...
         sebiz=new Dictionary();
         return;
      }

      public static function selorub(param1:BitmapData, param2:Number) : BitmapData {
         var _loc5_:* = true;
         var _loc6_:* = false;
         if(param2==1)
         {
         ...
         var _loc3_:Dictionary = sebiz[param2];
         if(_loc3_==null)
         {
            _loc3_=new Dictionary();
            sebiz[param2]=_loc3_;
      ...
      public static var syd:BitmapData = null;
      ...
      private static function getTexture(param1:int, param2:BitmapData) : BitmapData {
         ...
         switch(_loc4_)
         {
            ...
            case 1:
               ...
               break;
            case 4:
               _loc3_=AssetLibrary.jeqycu("textile4x4",_loc5_);
               break;
            case 5:
               _loc3_=AssetLibrary.jeqycu("textile5x5",_loc5_);
               break;
            case 9:
               _loc3_=AssetLibrary.jeqycu("textile9x9",_loc5_);
               break;
            case 10:
               _loc3_=AssetLibrary.jeqycu("textile10x10",_loc5_);
               break;
            case 255:
               _loc3_=syd;
               break;
      ...
      private static function retexture(param1:BitmapData, param2:BitmapData, param3:int, param4:int) : BitmapData {
         ...
         _loc6_.applyFilter(_loc6_,_loc6_.rect,PointUtil.qohusovu,new ShaderFilter(_loc9_));
         return _loc6_;
      }
