package com.company.util
{
   ...
   public class Kavi extends Object
   {
      public function Kavi(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number) {
         var _loc7_:* = true;
         var _loc8_:* = false;
         super();
         this.x0_=param1;
      ...
      public static function rof(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : Boolean {
         var _loc15_:* = false;
         var _loc16_:* = true;
      ...
      public static function johucydel(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number, param10:Number) : Boolean {
         var _loc11_:* = true;
         var _loc12_:* = false;
         ...
         return (zobyqepo(param1,param2,param3,param4,param7,param8,param9,param10))||(zobyqepo(param3,param4,param5,param6,param7,param8,param9,param10))||(zobyqepo(param5,param6,param1,param2,param7,param8,param9,param10));
      }

      private static function zobyqepo(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : Boolean {
         var _loc17_:* = false;
         var _loc18_:* = true;
         var _loc11_:* = NaN;
         var _loc12_:* = NaN;
      ...
      public function sanyrec() : Rectangle {
      ...
      public function wuhafafu() : Number {
         return Math.abs((this.x0_*(this.y1_-this.y2_)+this.x1_*(this.y2_-this.y0_)+this.x2_*(this.y0_-this.y1_))/2);
      }

      public function wegawira(param1:Point) : void {
         var _loc5_:* = true;
         var _loc6_:* = false;
         var _loc2_:Number = PointUtil.picetyl(this.x1_,this.y1_,this.x2_,this.y2_);
         var _loc3_:Number = PointUtil.picetyl(this.x0_,this.y0_,this.x2_,this.y2_);
         var _loc4_:Number = PointUtil.picetyl(this.x0_,this.y0_,this.x1_,this.y1_);
      ...
      public function distance(param1:Number, param2:Number) : Number {
         ...
         return Math.min(Kywa.pojut(param1,param2,this.x0_,this.y0_,this.x1_,this.y1_),Kywa.pojut(param1,param2,this.x1_,this.y1_,this.x2_,this.y2_),Kywa.pojut(param1,param2,this.x0_,this.y0_,this.x2_,this.y2_));
      }

      public function bir(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean {
         return johucydel(this.x0_,this.y0_,this.x1_,this.y1_,this.x2_,this.y2_,param1,param2,param3,param4);
      }
   }
