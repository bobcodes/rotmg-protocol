package com.company.util
{
   ...
   public class BitmapUtil extends Object
   {
      ...
      public static function fizyt(param1:BitmapData, param2:int) : BitmapData {
         var _loc5_:* = true;
         var _loc6_:* = false;
      ...
      public static function wygoci(param1:BitmapData, param2:int, param3:int, param4:int, param5:int) : BitmapData {
      ...
      public static function wyfeco(param1:BitmapData) : Number {
         var _loc6_:* = false;
         var _loc7_:* = true;
         var _loc4_:* = 0;
         var _loc5_:* = 0;
      ...
      public static function hitav(param1:BitmapData) : uint {
         var _loc13_:* = true;
         var _loc14_:* = false;
         var _loc3_:uint = 0;
      ...
      public static function gugytasid(param1:BitmapData, param2:IntPoint, param3:IntPoint) : Boolean {
         var _loc22_:* = true;
         var _loc23_:* = false;
         var _loc11_:* = 0;
         var _loc19_:* = 0;
