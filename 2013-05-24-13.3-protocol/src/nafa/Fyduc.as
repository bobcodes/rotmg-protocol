package nafa
{
   ...
   public class Fyduc extends Sprite
   {
      {
         var _loc1_:* = false;
         var _loc2_:* = true;
      ...
      public function Fyduc(param1:int) {
         var _loc2_:* = false;
         var _loc3_:* = true;
         super();
         this.type_=param1;
      ...
      protected static var toolTip_:Ryduwi = null;

      public var type_:int;

      protected var selected_:Boolean = false;

      protected var vefymyjul:Boolean = false;
      ...
      protected function getToolTip() : Ryduwi {
         return null;
      }
      ...
      private function draw() : void {
         ...
         graphics.beginFill(this.vefymyjul?5658198:3552822,1);
