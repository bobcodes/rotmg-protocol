package com.company.assembleegameclient.util
{
   ...
   import com.company.assembleegameclient.map.Gyn;
   import com.company.util.PointUtil;


   public class Boh extends Object
   {
      {
         var _loc1_:* = true;
         var _loc2_:* = false;
      ...
      public static function redraw(param1:Square, param2:Boolean) : BitmapData {
         ...
         {
            if(param1.props_.wyjedakad)
            {
               _loc3_=koqimac(param1);
            }
            else
            {
               _loc3_=nasu(param1);
         ...
         if(param1.tileType_==253)
         {
            _loc5_=lypuleni(_loc3_);
            _loc4_[_loc3_]=_loc5_;
            return _loc5_;
         }
         if(param1.props_.wyjedakad)
         {
            _loc5_=nekuvo(_loc3_);
            _loc4_[_loc3_]=_loc5_;
            return _loc5_;
         }
         var _loc6_:* = false;
      ...
      private static function zano(param1:BitmapData, param2:Rectangle, param3:Point, param4:Vector.<Fufudol>, param5:uint, param6:uint, param7:uint, param8:uint) : void {
         var _loc11_:* = true;
         var _loc12_:* = false;
         ...
         {
            _loc10_=param4[los].random();
            _loc9_=Qemujy.getBitmapData(param7);
         }
         else
         {
            if(!(param5==param6)&&!(param5==param8))
            {
               if(param6!=param8)
               {
                  param1.copyPixels(Qemujy.getBitmapData(param6),param2,param3,param4[INNERP1].random(),p0,true);
                  param1.copyPixels(Qemujy.getBitmapData(param8),param2,param3,param4[INNERP2].random(),p0,true);
                  return;
               }
               _loc10_=param4[bece].random();
               _loc9_=Qemujy.getBitmapData(param6);
            }
            else
            {
               if(param5!=param6)
               ...
               else
               {
                  ...
                  _loc9_=Qemujy.getBitmapData(param8);
               }
            }
         }
      ...
      private static function nasu(param1:Square) : ByteArray {
         var _loc8_:* = true;
         var _loc9_:* = false;
         var _loc6_:* = 0;
         ...
         while(_loc5_<=param1.y_+1)
         {
            ...
            while(_loc6_<=param1.x_+1)
            {
               ...
               else
               {
                  ...
                  if(_loc7_==null||_loc7_.props_.wid<=param1.props_.wid)
                  {
                     _loc2_.writeByte(_loc4_);
                  }
                  else
      ...
      private static function wupiqegos() : Vector.<Vector.<Fufudol>> {
         var _loc2_:* = true;
         var _loc3_:* = false;
         var _loc1_:Vector.<Vector.<Fufudol>> = new Vector.<Vector.<Fufudol>>();
         remujyme(_loc1_,AssetLibrary.bugu("inner_mask"),AssetLibrary.bugu("sides_mask"),AssetLibrary.bugu("outer_mask"),AssetLibrary.bugu("innerP1_mask"),AssetLibrary.bugu("innerP2_mask"));
         return _loc1_;
      }

      private static function remujyme(param1:Vector.<Vector.<Fufudol>>, param2:Fufudol, param3:Fufudol, param4:Fufudol, param5:Fufudol, param6:Fufudol) : void {
         var _loc10_:* = true;
         var _loc11_:* = false;
         var _loc7_:* = 0;
         for each (_loc7_ in [-1,0,2,1])
         {
            new Vector.<Fufudol>(6)[0]=myjevited(param2,_loc7_);
            new Vector.<Fufudol>(6)[1]=myjevited(param3,_loc7_-1);
            new Vector.<Fufudol>(6)[2]=myjevited(param3,_loc7_);
            new Vector.<Fufudol>(6)[3]=myjevited(param4,_loc7_);
            new Vector.<Fufudol>(6)[4]=myjevited(param5,_loc7_);
            new Vector.<Fufudol>(6)[5]=myjevited(param6,_loc7_);
            param1.push(new Vector.<Fufudol>(6));
         }
         return;
      }

      private static function myjevited(param1:Fufudol, param2:int) : Fufudol {
         var _loc7_:* = false;
         var _loc8_:* = true;
         var _loc4_:BitmapData = null;
         var _loc3_:Fufudol = new Fufudol();
         for each (_loc4_ in param1.gisydi)
         {
            _loc3_.add(BitmapUtil.nocoqiz(_loc4_,param2));
         }
         return _loc3_;
      }

      private static function jyl(param1:Square) : ByteArray {
         var _loc18_:* = false;
         var _loc19_:* = true;
         ...
         var _loc10_:int = _loc6_!=null?_loc6_.props_.leg:-1;
         var _loc11_:int = _loc7_!=null?_loc7_.props_.leg:-1;
         var _loc12_:int = _loc8_!=null?_loc8_.props_.leg:-1;
         var _loc13_:int = _loc9_!=null?_loc9_.props_.leg:-1;
         if(_loc10_<0&&_loc11_<0)
         {
            _loc14_=_loc3_.lookupSquare(_loc4_-1,_loc5_-1);
            _loc2_[0]=_loc14_==null||_loc14_.props_.leg<0?255:_loc14_.tileType_;
         }
         else
         {
            if(_loc10_<_loc11_)
         ...
         if(_loc10_<0&&_loc12_<0)
         {
            ...
            _loc2_[1]=_loc15_==null||_loc15_.props_.leg<0?255:_loc15_.tileType_;
         }
         else
         {
            if(_loc10_<_loc12_)
         ...
         if(_loc11_<0&&_loc13_<0)
         {
            ...
            _loc2_[2]=_loc16_==null||_loc16_.props_.leg<0?255:_loc16_.tileType_;
         }
         else
         {
            if(_loc11_<_loc13_)
         ...
         if(_loc12_<0&&_loc13_<0)
         {
            ...
            _loc2_[3]=_loc17_==null||_loc17_.props_.leg<0?255:_loc17_.tileType_;
         }
         else
         {
            if(_loc12_<_loc13_)
      ...
      private static function lypuleni(param1:ByteArray) : BitmapData {
         var _loc4_:* = true;
         var _loc5_:* = false;
         ...
         if(param1[0]!=255)
         {
            _loc3_=Qemujy.getBitmapData(param1[0]);
            _loc2_.copyPixels(_loc3_,RECT0,POINT0);
         }
         if(param1[1]!=255)
         {
            _loc3_=Qemujy.getBitmapData(param1[1]);
            _loc2_.copyPixels(_loc3_,RECT1,POINT1);
         }
         if(param1[2]!=255)
         {
            _loc3_=Qemujy.getBitmapData(param1[2]);
            _loc2_.copyPixels(_loc3_,RECT2,POINT2);
         }
         if(param1[3]!=255)
         {
            _loc3_=Qemujy.getBitmapData(param1[3]);
            _loc2_.copyPixels(_loc3_,RECT3,POINT3);
         }
         return _loc2_;
      }

      private static function koqimac(param1:Square) : ByteArray {
         var _loc10_:* = true;
         var _loc11_:* = false;
         var _loc7_:* = 0;
         ...
         var _loc3_:Map = param1.map_;
         var _loc4_:* = false;
         var _loc5_:Boolean = param1.props_.tihasyn;
      ...
      private static function nekuvo(param1:ByteArray) : BitmapData {
         var _loc8_:* = false;
         var _loc9_:* = true;
         var _loc2_:BitmapData = Qemujy.getBitmapData(param1[4]);
         var _loc3_:BitmapData = _loc2_.clone();
         var _loc4_:Gyn = Qemujy.zupucuwum[param1[4]];
         var _loc5_:Vector.<BitmapData> = _loc4_.lypegyfu();
         var _loc6_:Vector.<BitmapData> = _loc4_.wytiv();
         var _loc7_:* = 1;
         while(_loc7_<8)
         {
            if(!param1[_loc7_])
            {
               _loc3_.copyPixels(_loc5_[_loc7_],_loc5_[_loc7_].rect,PointUtil.wota,null,null,true);
            }
            _loc7_=_loc7_+2;
         }
         if(_loc5_[0]!=null)
         {
            ...
            {
               _loc3_.copyPixels(_loc5_[0],_loc5_[0].rect,PointUtil.wota,null,null,true);
            }
            if((param1[1])&&(param1[5])&&!param1[2])
            {
               _loc3_.copyPixels(_loc5_[2],_loc5_[2].rect,PointUtil.wota,null,null,true);
            }
            if((param1[5])&&(param1[7])&&!param1[8])
            {
               _loc3_.copyPixels(_loc5_[8],_loc5_[8].rect,PointUtil.wota,null,null,true);
            }
            if((param1[3])&&(param1[7])&&!param1[6])
            {
               _loc3_.copyPixels(_loc5_[6],_loc5_[6].rect,PointUtil.wota,null,null,true);
            }
         }
         if(_loc6_!=null)
         {
            ...
            {
               _loc3_.copyPixels(_loc6_[0],_loc6_[0].rect,PointUtil.wota,null,null,true);
            }
            if(!param1[1]&&!param1[5])
            {
               _loc3_.copyPixels(_loc6_[2],_loc6_[2].rect,PointUtil.wota,null,null,true);
            }
            if(!param1[5]&&!param1[7])
            {
               _loc3_.copyPixels(_loc6_[8],_loc6_[8].rect,PointUtil.wota,null,null,true);
            }
            if(!param1[3]&&!param1[7])
            {
               _loc3_.copyPixels(_loc6_[6],_loc6_[6].rect,PointUtil.wota,null,null,true);
            }
         }
         return _loc3_;
      }
