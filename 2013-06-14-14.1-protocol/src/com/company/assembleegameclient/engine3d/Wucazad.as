package com.company.assembleegameclient.engine3d
{
   ...
   public class Wucazad extends Object
   {
      {
         var _loc1_:* = false;
         var _loc2_:* = true;
      ...
      public function Wucazad() {
         var _loc1_:* = true;
         var _loc2_:* = false;
         this.vL_=new Vector.<Number>();
         this.uvts_=new Vector.<Number>();
         this.faces_=new Vector.<Wamosewe>();
         super();
         return;
      }

      private static var cupety:Object = new Object();

      public static function bisyme(param1:String, param2:String) : void {
         var _loc27_:* = true;
         var _loc28_:* = false;
         var _loc11_:String = null;
         var _loc12_:Wucazad = null;
         ...
         for each (_loc13_ in _loc6_)
         {
            ...
            ConversionUtil.mulaq(_loc4_[int(_loc18_[0])-1],_loc12_.vL_);
            if(_loc18_.length>1&&_loc18_[1].length>0)
            {
               ConversionUtil.mulaq(_loc5_[int(_loc18_[1])-1],_loc12_.uvts_);
         ...
         while(_loc14_<_loc8_.length)
         {
            ...
            _loc12_.faces_.push(new Wamosewe(_loc12_,_loc21_,_loc20_==null||!(_loc20_.substr(0,5)=="Solid")));
            _loc14_++;
         }
         _loc12_.vilu();
         cupety[param1]=_loc12_;
         return;
      }

      public static function womude(param1:String) : Wucazad {
         return cupety[param1];
      }

      public static function law(param1:String) : Vutyrut {
         var _loc3_:* = true;
         var _loc4_:* = false;
         var _loc2_:Wucazad = cupety[param1];
         if(_loc2_==null)
         {
            return null;
         }
      ...
      public var faces_:Vector.<Wamosewe>;
      ...
      public function vilu() : void {
         var _loc1_:* = true;
         var _loc2_:* = false;
         this.faces_.sort(Wamosewe.sokaqobod);
         return;
      }
   }
