package com.company.assembleegameclient.screens.charrects
{
   ...
   public class CharacterRect extends Sprite
   {
      ...
      protected var taglineText:Guzowoja;

      protected var classNameText:Guzowoja;

      protected var className:Tunyhazo;
      ...
      protected function makeClassNameText() : void {
         this.classNameText=new Guzowoja().setSize(18).setColor(16777215);
      ...
      protected function makeTaglineText(param1:Tunyhazo) : void {
         this.taglineText=new Guzowoja().setSize(14).setColor(11776947);
