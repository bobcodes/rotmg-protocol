   ...
   public class Wall extends GameObject
   {
      ...
      override public function draw(param1:Vector.<IGraphicsData>, param2:Qawosiwi, param3:int) : void {
         ...
         while(_loc5_<this.faces_.length)
         {
            ...
            if(_loc8_==null||_loc8_.texture_==null||!(_loc8_==null)&&_loc8_.obj_ is Wall&&!_loc8_.obj_.logi)
            {
               _loc7_.fyfinu=true;
            }
            else
      ...
      public function jamabeki() : void {
         ...
         this.qome(_loc1_,_loc2_,1,_loc1_+1,_loc2_,1);
         this.qome(_loc1_+1,_loc2_,1,_loc1_+1,_loc2_+1,1);
         this.qome(_loc1_+1,_loc2_+1,1,_loc1_,_loc2_+1,1);
         this.qome(_loc1_,_loc2_+1,1,_loc1_,_loc2_,1);
         return;
      }
      ...
      private function qome(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number) : void {
         ...
         var _loc8_:Face3D = new Face3D(texture_,_loc7_,vucip,true,true);
