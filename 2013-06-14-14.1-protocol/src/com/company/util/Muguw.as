package com.company.util
{
   ...
   public class Muguw extends Object
   {
      public function Muguw(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number) {
         var _loc7_:* = false;
         var _loc8_:* = true;
         super();
         this.x0_=param1;
      ...
      public static function janivyz(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : Boolean {
         var _loc15_:* = false;
         var _loc16_:* = true;
      ...
      public static function larano(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number, param10:Number) : Boolean {
         var _loc11_:* = false;
         var _loc12_:* = true;
         ...
         return (padocaho(param1,param2,param3,param4,param7,param8,param9,param10))||(padocaho(param3,param4,param5,param6,param7,param8,param9,param10))||(padocaho(param5,param6,param1,param2,param7,param8,param9,param10));
      }

      private static function padocaho(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : Boolean {
         var _loc17_:* = false;
         var _loc18_:* = true;
         var _loc11_:* = NaN;
         var _loc12_:* = NaN;
      ...
      public function sihaqyd() : Rectangle {
      ...
      public function fylok() : Number {
         return Math.abs((this.x0_*(this.y1_-this.y2_)+this.x1_*(this.y2_-this.y0_)+this.x2_*(this.y0_-this.y1_))/2);
      }

      public function soke(param1:Point) : void {
         var _loc5_:* = false;
         var _loc6_:* = true;
         var _loc2_:Number = PointUtil.nybomof(this.x1_,this.y1_,this.x2_,this.y2_);
         var _loc3_:Number = PointUtil.nybomof(this.x0_,this.y0_,this.x2_,this.y2_);
         var _loc4_:Number = PointUtil.nybomof(this.x0_,this.y0_,this.x1_,this.y1_);
      ...
      public function distance(param1:Number, param2:Number) : Number {
         ...
         return Math.min(Defequcak.qevumynun(param1,param2,this.x0_,this.y0_,this.x1_,this.y1_),Defequcak.qevumynun(param1,param2,this.x1_,this.y1_,this.x2_,this.y2_),Defequcak.qevumynun(param1,param2,this.x0_,this.y0_,this.x2_,this.y2_));
      }

      public function jewig(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean {
         return larano(this.x0_,this.y0_,this.x1_,this.y1_,this.x2_,this.y2_,param1,param2,param3,param4);
      }
   }
