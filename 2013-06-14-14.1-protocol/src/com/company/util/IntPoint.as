package com.company.util
{
   ...
   public class IntPoint extends Object
   {
      ...
      public static function muqik() : void {
         var _loc1_:UnitTest = new UnitTest();
         return;
      }

      public static function haquzizob(param1:Point) : IntPoint {
      ...
      public function kico(param1:int) : void {
         var _loc2_:* = false;
         var _loc3_:* = true;
         this.x_=param1;
         return;
      ...
      public function mikuz(param1:int) : void {
         var _loc2_:* = true;
         var _loc3_:* = false;
         this.y_=param1;
         return;
      ...
      public function wova(param1:IntPoint) : Boolean {
         var _loc2_:* = false;
         var _loc3_:* = true;
         return this.x_==param1.x_&&this.y_==param1.y_;
      }

      public function zylegevu(param1:IntPoint) : int {
         var _loc4_:* = true;
         var _loc5_:* = false;
      ...
      public function covyv(param1:IntPoint) : Number {
         var _loc4_:* = true;
         var _loc5_:* = false;
         var _loc2_:int = param1.x_-this.x_;
         var _loc3_:int = param1.y_-this.y_;
      ...
      public function pava(param1:Point) : Number {
      ...
      public function fekufelu(param1:IntPoint) : int {
         var _loc4_:* = true;
         var _loc5_:* = false;
         var _loc2_:int = param1.x()-this.x_;
         var _loc3_:int = param1.y()-this.y_;
      ...
      public function transform(param1:Matrix) : IntPoint {
         var _loc2_:Point = param1.transformPoint(this.nydu());
