package com.company.util
{
   ...
   public class Defequcak extends Object
   {
      public function Defequcak() {
         var _loc1_:* = false;
         var _loc2_:* = true;
         super();
         return;
      ...
      public static function lokyholy(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : Point {
         var _loc13_:* = false;
         var _loc14_:* = true;
      ...
      public static function qevumynun(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number) : Number {
         var _loc13_:* = true;
         var _loc14_:* = false;
         var _loc10_:* = NaN;
         var _loc11_:* = NaN;
