package com.company.util
{
   ...
   public class Trig extends Object
   {
      ...
      public static const ryje:Number = 180/Math.PI;

      public static const totugiwu:Number = Math.PI/180;

      public static function pumu(param1:Number, param2:Number, param3:Number) : Number {
         var _loc5_:* = false;
         var _loc6_:* = true;
         ...
         {
            _loc4_=kuqyroqub(_loc4_);
         }
         return _loc4_;
      }

      public static function zawe(param1:Number, param2:Number) : Number {
         var _loc3_:* = false;
         var _loc4_:* = true;
         if(param1>param2)
         {
      ...
      public static function kuqyroqub(param1:Number) : Number {
         var _loc3_:* = true;
         var _loc4_:* = false;
         var _loc2_:* = 0;
         if(param1<-Math.PI)
      ...
      public static function syfujav(param1:Number) : Number {
         var _loc3_:* = true;
         var _loc4_:* = false;
         var _loc2_:* = 0;
         if(param1<-180)
      ...
      public static function testFunc1(param1:Function, param2:Function) : Boolean {
         ...
         while(_loc4_<1000)
         {
            _loc5_=_loc3_.byloben()%2000-1000+_loc3_.digazotoj();
      ...
      public static function testFunc2(param1:Function, param2:Function) : Boolean {
         ...
         {
            _loc5_=_loc3_.byloben()%2000-1000+_loc3_.digazotoj();
            _loc6_=_loc3_.byloben()%2000-1000+_loc3_.digazotoj();
