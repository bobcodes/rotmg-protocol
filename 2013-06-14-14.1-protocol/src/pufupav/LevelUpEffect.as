package pufupav
{
   ...
   public class LevelUpEffect extends Miwimemo
   {
      {
         var _loc1_:* = false;
         var _loc2_:* = true;
      ...
      private static const dejibo:int = 2000;
      ...
      override public function update(param1:int, param2:int) : Boolean {
         ...
         var _loc3_:Number = (param1-this.startTime_)/dejibo;
         if(_loc3_>=1)
         {
            this.mulohag();
            return false;
         }
         this.binef(this.parts1_,1,0,_loc3_);
         this.binef(this.parts2_,1,Math.PI,_loc3_);
         return true;
      }

      private function mulohag() : void {
         var _loc4_:* = false;
         var _loc5_:* = true;
      ...
      public function binef(param1:Vector.<LevelUpParticle>, param2:Number, param3:Number, param4:Number) : void {
         var _loc10_:* = true;
         var _loc11_:* = false;
         var _loc5_:* = 0;
