package pufupav
{
   ...
   public class Sotavef extends Miwimemo
   {
      ...
      override public function update(param1:int, param2:int) : Boolean {
         ...
         var _loc6_:* = 7;
         var _loc7_:Number = Math.atan2(this.gynyjaco.y_-this.start_.y,this.gynyjaco.x_-this.start_.x);
         var _loc8_:* = 0;
         while(_loc8_<_loc6_)
         {
            _loc9_=_loc7_-_loc5_/2+_loc8_*_loc5_/_loc6_;
            _loc10_=new Point(this.start_.x+this.hobyw*Math.cos(_loc9_),this.start_.y+this.hobyw*Math.sin(_loc9_));
            _loc11_=new Zozy(_loc3_,this.color_,_loc4_,this.start_,_loc10_);
