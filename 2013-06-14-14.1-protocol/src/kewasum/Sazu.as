package kewasum
{
   ...
   public class Sazu extends Object
   {
      {
         var _loc1_:* = false;
         var _loc2_:* = true;
      ...
      public static function encode(param1:BitmapData) : ByteArray {
         ...
         _loc3_.writeByte(0);
         jypopafah(_loc2_,1229472850,_loc3_);
         ...
         _loc4_.compress();
         jypopafah(_loc2_,1229209940,_loc4_);
         jypopafah(_loc2_,1229278788,null);
         return _loc2_;
      }

      private static var wuni:Array;

      private static var vezene:Boolean = false;

      private static function jypopafah(param1:ByteArray, param2:uint, param3:ByteArray) : void {
         var _loc11_:* = true;
         var _loc12_:* = false;
         var _loc8_:uint = 0;
         var _loc9_:uint = 0;
         ...
         {
            _loc8_=uint(wuni[(_loc8_^param1.readUnsignedByte())&uint(255)]^uint(_loc8_>>>8));
            _loc7_++;
         }
