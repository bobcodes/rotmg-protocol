package com.company.util
{
   ...
   public class Tizulo extends Object
   {
      {
         var _loc1_:* = false;
         var _loc2_:* = true;
      ...
      public static const hyz:Vector.<int> = new Vector.<int>(4);

      public static const zaqoweteb:GraphicsStroke = new GraphicsStroke(1,false,LineScaleMode.NORMAL,CapsStyle.NONE,JointStyle.ROUND,3,new GraphicsSolidFill(16711680));

      public static const gejyd:GraphicsStroke = new GraphicsStroke();

      public static function vomynaqu(param1:GraphicsPath) : void {
         var _loc2_:* = false;
         var _loc3_:* = true;
      ...
      public static function bekawu(param1:int, param2:int, param3:int, param4:int) : GraphicsPath {
         ...
         return new GraphicsPath(hyz,new Vector.<Number>(8));
      }

      public static function gajafy(param1:Number, param2:Number, param3:Number=0.0, param4:Number=0.0, param5:Number=0.0) : Matrix {
      ...
      private static const qeguvyz:Number = 2*Math.PI;
      ...
      public static function drawCircle(param1:Number, param2:Number, param3:Number, param4:GraphicsPath, param5:int=8) : void {
         ...
         while(_loc7_<=param5)
         {
            _loc8_=qeguvyz*_loc7_/param5;
            _loc9_=qeguvyz*(_loc7_-0.5)/param5;
      ...
      public static const luhalotut:Array = [true,true,true,true];

      public static function woforyzib(param1:int, param2:int, param3:int, param4:int, param5:int, param6:Array, param7:GraphicsPath) : void {
         var _loc8_:* = true;
         var _loc9_:* = false;
         if(param6[0]!=0)
         {
      ...
      public static function wovisuquk(param1:Number, param2:Number, param3:Number, param4:GraphicsPath) : void {
         var _loc5_:* = true;
         var _loc6_:* = false;
