package com.company.assembleegameclient.engine3d
{
   ...
   public class Line3D extends Object
   {
      ...
      public function refun(param1:Line3D) : int {
         var _loc8_:* = false;
         var _loc9_:* = true;
         ...
         return Order.jekupynuh;
      }

      public function vibe(param1:Number) : Vector3D {
   ...
   class UnitTest extends Object
   {
      ...
      private static function testCrossZ() : Boolean {
         ...
         if(_loc1_.refun(_loc2_)!=Order.faj)
         {
            return false;
         }
         if(_loc2_.refun(_loc1_)!=Order.jekupynuh)
         {
            return false;
         }
