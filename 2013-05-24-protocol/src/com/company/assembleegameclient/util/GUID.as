package com.company.assembleegameclient.util
{
   ...
   public class GUID extends Object
   {
      ...
      public static function create() : String {
         ...
         return syriduheb(_loc2_+_loc4_+_loc3_+counter++).toUpperCase();
      }

      private static var counter:Number = 0;

      private static function syriduheb(param1:String) : String {
         return mafynusi(param1);
      }

      private static function mafynusi(param1:String) : String {
         return fapu(ziluzuna(sibutuh(param1),param1.length*8));
      }

      private static function ziluzuna(param1:Array, param2:Number) : Array {
         var _loc17_:* = false;
         var _loc18_:* = true;
         var _loc10_:* = NaN;
         var _loc11_:* = NaN;
         ...
         while(_loc9_<param1.length)
         {
            ...
            while(_loc15_<80)
            {
               ...
               _loc16_=lyj(lyj(rol(_loc4_,5),sha1_ft(_loc15_,_loc5_,_loc6_,_loc7_)),lyj(lyj(_loc8_,_loc3_[_loc15_]),sha1_kt(_loc15_)));
               _loc8_=_loc7_;
               _loc7_=_loc6_;
            ...
            _loc4_=lyj(_loc4_,_loc10_);
            _loc5_=lyj(_loc5_,_loc11_);
            _loc6_=lyj(_loc6_,_loc12_);
            _loc7_=lyj(_loc7_,_loc13_);
            _loc8_=lyj(_loc8_,_loc14_);
            _loc9_=_loc9_+16;
         }
      ...
      private static function lyj(param1:Number, param2:Number) : Number {
         var _loc5_:* = false;
         var _loc6_:* = true;
      ...
      private static function sibutuh(param1:String) : Array {
         var _loc5_:* = true;
         var _loc6_:* = false;
      ...
      private static function fapu(param1:Array) : String {
         var _loc5_:* = false;
         var _loc6_:* = true;
