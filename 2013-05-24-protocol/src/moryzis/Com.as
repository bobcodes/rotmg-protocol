package moryzis
{
   ...
   public class Com extends Jil
   {
      public function Com(param1:GameObject, param2:Wakudava, param3:int) {
         var _loc4_:* = false;
         var _loc5_:* = true;
         super();
      ...
      override public function update(param1:int, param2:int) : Boolean {
         ...
         while(_loc4_<_loc3_)
         {
            ...
            _loc6_=new Lupu(100,this.color_,700,0.5,Hatuf.melemy(1),Hatuf.melemy(1));
