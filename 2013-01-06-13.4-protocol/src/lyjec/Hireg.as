package lyjec
{
[CLASS1741]   import flash.utils.ByteArray;
   import flash.display.BitmapData;


   public class Hireg extends Object
   {
      {
         var _loc1_:* = false;
         var _loc2_:* = true;
      ...
      public static function encode(param1:BitmapData) : ByteArray {
         ...
         _loc4_.compress();
         nyw(_loc2_,1229209940,_loc4_);
         nyw(_loc2_,1229278788,null);
         return _loc2_;
      }

      private static var vosam:Array;

      private static var gicytywaw:Boolean = false;

      private static function nyw(param1:ByteArray, param2:uint, param3:ByteArray) : void {
         var _loc11_:* = true;
         var _loc12_:* = false;
         var _loc8_:uint = 0;
         var _loc9_:uint = 0;
         ...
         {
            _loc8_=uint(vosam[(_loc8_^param1.readUnsignedByte())&uint(255)]^uint(_loc8_>>>8));
            _loc7_++;
         }
