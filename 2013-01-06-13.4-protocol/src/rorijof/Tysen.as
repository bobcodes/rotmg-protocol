package rorijof
{
[CLASS899]   import flash.errors.IllegalOperationError;
   import flash.display.DisplayObject;
   import flash.geom.Rectangle;


   public class Tysen extends Object
   {
      public function Tysen() {
         var _loc1_:* = true;
         var _loc2_:* = false;
         super();
         return;
      ...
      public function layout(param1:int, ... rest) : void {
         ...
         {
            case 1:
               this.zycanydyb(param1,rest[0]);
               break;
            case 2:
               this.gihakehyd(param1,rest[0],rest[1]);
               break;
            default:
      ...
      private function zycanydyb(param1:int, param2:DisplayObject) : void {
         var _loc4_:* = false;
         var _loc5_:* = true;
      ...
      private function gihakehyd(param1:int, param2:DisplayObject, param3:DisplayObject) : void {
         var _loc6_:* = true;
         var _loc7_:* = false;
