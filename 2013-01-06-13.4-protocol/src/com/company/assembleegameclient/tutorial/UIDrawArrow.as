...
{
[CLASS1420]   import flash.geom.Point;
   ...
   public class UIDrawArrow extends Object
   {
      public function UIDrawArrow(param1:XML) {
         ...
         var _loc4_:* = false;
         super();
         var _loc2_:Array = ConversionUtil.fuwejid(param1);
         this.p0_=_loc2_[0];
         this.p1_=_loc2_[1];
      ...
      public function draw(param1:int, param2:Graphics, param3:int) : void {
         ...
         if(param3<this.sam)
         {
            _loc4_.x=this.p0_.x+(this.p1_.x-this.p0_.x)*param3/this.sam;
            _loc4_.y=this.p0_.y+(this.p1_.y-this.p0_.y)*param3/this.sam;
         }
         else
         {
            _loc4_.x=this.p1_.x;
         ...
         var _loc5_:Number = PointUtil.cesarubo(_loc4_,this.p0_);
         _loc6_=PointUtil.pymycydi(_loc4_,_loc5_+Math.PI/8,30);
