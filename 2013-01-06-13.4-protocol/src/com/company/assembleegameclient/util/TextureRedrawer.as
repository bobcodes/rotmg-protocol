...
{
[CLASS844]   import flash.filters.GlowFilter;
   ...
   public class TextureRedrawer extends Object
   {
      ...
      public static const vipib:int = 12;

      public static const nac:int = 2*vipib;
      ...
      private static var bidupeneb:Dictionary = new Dictionary();
      ...
      public static function resize(param1:BitmapData, param2:BitmapData, param3:int, param4:Boolean, param5:int, param6:int, param7:Number=5) : BitmapData {
         ...
         _loc10_.translate(vipib,vipib);
         var _loc11_:BitmapData = new BitmapData(_loc8_+nac,_loc9_+(param4?vipib:1)+vipib,true,0);
      ...
      public static function outlineGlow(param1:BitmapData, param2:uint, param3:uint, param4:Number=1.4) : BitmapData {
         ...
         _loc5_.applyFilter(_loc5_,_loc5_.rect,PointUtil.tirumyf,OUTLINE_FILTER);
         if(param3!=4.294967295E9)
         {
            GLOW_FILTER.color=param3;
            _loc5_.applyFilter(_loc5_,_loc5_.rect,PointUtil.tirumyf,GLOW_FILTER);
         }
         return _loc5_;
      }
      ...
      public static function redrawSolidSquare(param1:uint, param2:int) : BitmapData {
         ...
         _loc4_.applyFilter(_loc4_,_loc4_.rect,PointUtil.tirumyf,OUTLINE_FILTER);
      ...
      public static function clearCache() : void {
         ...
         bidupeneb=new Dictionary();
         return;
      }

      public static function lilycomes(param1:BitmapData, param2:Number) : BitmapData {
         var _loc5_:* = false;
         var _loc6_:* = true;
         if(param2==1)
         {
         ...
         var _loc3_:Dictionary = bidupeneb[param2];
         if(_loc3_==null)
         {
            _loc3_=new Dictionary();
            bidupeneb[param2]=_loc3_;
         }
         var _loc4_:BitmapData = _loc3_[param1];
         if(_loc4_!=null)
         {
      ...
      public static var qujo:BitmapData = null;
      ...
      private static function getTexture(param1:int, param2:BitmapData) : BitmapData {
         ...
         switch(null)
         {
            ...
            case 1:
               ...
               break;
            case 4:
               _loc3_=AssetLibrary.zovy("textile4x4",_loc5_);
               break;
            case 5:
               _loc3_=AssetLibrary.zovy("textile5x5",_loc5_);
               break;
            case 9:
               _loc3_=AssetLibrary.zovy("textile9x9",_loc5_);
               break;
            case 10:
               _loc3_=AssetLibrary.zovy("textile10x10",_loc5_);
               break;
            case 255:
               _loc3_=qujo;
               break;
      ...
      private static function retexture(param1:BitmapData, param2:BitmapData, param3:int, param4:int) : BitmapData {
         ...
         _loc6_.applyFilter(_loc6_,_loc6_.rect,PointUtil.tirumyf,new ShaderFilter(_loc9_));
         return _loc6_;
      }
