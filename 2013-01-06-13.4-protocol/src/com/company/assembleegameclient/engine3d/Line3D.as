...
{
[CLASS1891]   import flash.geom.Vector3D;
   ...
   public class Line3D extends Object
   {
      ...
      public function tomykiqat(param1:Line3D) : int {
         var _loc8_:* = false;
         var _loc9_:* = true;
         ...
         if(_loc7_>0)
         {
            return Order.gywihap;
         }
         return Order.gev;
      }

      public function ciwa(param1:Number) : Vector3D {
...
[/CLASS]
}[CLASS1892]   import com.company.assembleegameclient.engine3d.Line3D;
   ...
   class UnitTest extends Object
   {
      ...
      private static function testCrossZ() : Boolean {
         ...
         if(_loc1_.tomykiqat(_loc2_)!=Order.gywihap)
         {
            return false;
         }
         if(_loc2_.tomykiqat(_loc1_)!=Order.gev)
         {
            return false;
         }
