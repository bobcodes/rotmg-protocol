...
{
[CLASS586]   import __AS3__.vec.Vector;
   import com.company.util.ConversionUtil;


   public class Pyhotuni extends Object
   {
      {
         var _loc1_:* = true;
         var _loc2_:* = false;
      ...
      public function Pyhotuni() {
         var _loc1_:* = false;
         var _loc2_:* = true;
         this.vL_=new Vector.<Number>();
         this.uvts_=new Vector.<Number>();
         this.faces_=new Vector.<Kevyref>();
         super();
         return;
      }

      private static var kof:Object = new Object();

      public static function lucatoqi(param1:String, param2:String) : void {
         var _loc27_:* = true;
         var _loc28_:* = false;
         var _loc11_:String = null;
         var _loc12_:Pyhotuni = null;
         ...
         _loc12_=new Pyhotuni();
         for each (_loc13_ in _loc6_)
         {
            _loc18_=_loc13_.split("/");
            ConversionUtil.piziroc(_loc4_[int(_loc18_[0])-1],_loc12_.vL_);
            if(_loc18_.length>1&&_loc18_[1].length>0)
            {
               ConversionUtil.piziroc(_loc5_[int(_loc18_[1])-1],_loc12_.uvts_);
         ...
         while(_loc14_<_loc8_.length)
         {
            ...
            _loc12_.faces_.push(new Kevyref(_loc12_,_loc21_,_loc20_==null||!(_loc20_.substr(0,5)=="Solid")));
            _loc14_++;
         }
         _loc12_.tyji();
         kof[param1]=_loc12_;
      ...
      public static function salapy(param1:String) : Pyhotuni {
         return kof[param1];
      }

      public static function timaf(param1:String) : Daburap {
         var _loc3_:* = true;
         var _loc4_:* = false;
         var _loc2_:Pyhotuni = kof[param1];
         if(_loc2_==null)
         {
            return null;
         }
      ...
      public var faces_:Vector.<Kevyref>;
      ...
      public function tyji() : void {
         var _loc1_:* = false;
         var _loc2_:* = true;
         this.faces_.sort(Kevyref.zedonog);
         return;
      }
   }
[/CLASS]
