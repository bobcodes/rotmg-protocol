...
{
[CLASS1094]   import flash.geom.Rectangle;
   import flash.geom.Point;
   import flash.geom.Matrix;


   public class Gor extends Object
   {
      public function Gor() {
         var _loc1_:* = true;
         var _loc2_:* = false;
      ...
      public static function rivy(param1:Rectangle, param2:Number, param3:Number) : Number {
         var _loc6_:* = false;
         var _loc7_:* = true;
         ...
         return PointUtil.kijuvaq(_loc4_,_loc5_,param2,param3);
      }

      public static function viv(param1:Rectangle, param2:Number, param3:Number) : Point {
         var _loc6_:* = false;
         var _loc7_:* = true;
         var _loc4_:Number = param2;
         var _loc5_:Number = param3;
      ...
      public static function qudityh(param1:Rectangle, param2:Number, param3:Number, param4:Number, param5:Number) : Boolean {
         var _loc14_:* = true;
         var _loc15_:* = false;
         var _loc8_:* = NaN;
         var _loc9_:* = NaN;
      ...
      public static function suhoderoq(param1:Rectangle, param2:Number, param3:Number, param4:Number, param5:Number, param6:Point) : Boolean {
         var _loc11_:* = false;
         var _loc12_:* = true;
         var _loc7_:* = NaN;
         var _loc8_:* = NaN;
      ...
      public static function gyf(param1:Rectangle, param2:IntPoint, param3:IntPoint) : Point {
         var _loc8_:* = false;
         var _loc9_:* = true;
         var _loc4_:* = NaN;
         var _loc5_:* = NaN;
      ...
      public static function memojyden(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number) : Niquz {
         var _loc12_:* = false;
         var _loc13_:* = true;
