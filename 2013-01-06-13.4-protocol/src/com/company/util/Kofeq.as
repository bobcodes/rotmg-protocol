...
{
[CLASS1893]   import flash.geom.Point;


   public class Kofeq extends Object
   {
      public function Kofeq() {
         var _loc1_:* = true;
         var _loc2_:* = false;
         super();
         return;
      ...
      public static function fabu(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : Point {
         var _loc13_:* = true;
         var _loc14_:* = false;
      ...
      public static function viledy(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number) : Number {
         var _loc13_:* = true;
         var _loc14_:* = false;
         var _loc10_:* = NaN;
         var _loc11_:* = NaN;
