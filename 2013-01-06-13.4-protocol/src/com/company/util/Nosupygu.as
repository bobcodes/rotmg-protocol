...
{
[CLASS937]   import flash.display.GraphicsEndFill;
   ...
   public class Nosupygu extends Object
   {
      {
         var _loc1_:* = false;
         var _loc2_:* = true;
      ...
      public static const quk:Vector.<int> = new Vector.<int>(4);

      public static const tin:GraphicsStroke = new GraphicsStroke(1,false,LineScaleMode.NORMAL,CapsStyle.NONE,JointStyle.ROUND,3,new GraphicsSolidFill(16711680));

      public static const puzy:GraphicsStroke = new GraphicsStroke();

      public static function jyrodepu(param1:GraphicsPath) : void {
         var _loc2_:* = true;
         var _loc3_:* = false;
      ...
      public static function bacebe(param1:int, param2:int, param3:int, param4:int) : GraphicsPath {
         ...
         return new GraphicsPath(quk,new Vector.<Number>(8));
      }

      public static function piva(param1:Number, param2:Number, param3:Number=0.0, param4:Number=0.0, param5:Number=0.0) : Matrix {
      ...
      private static const luqi:Number = 2*Math.PI;
      ...
      public static function drawCircle(param1:Number, param2:Number, param3:Number, param4:GraphicsPath, param5:int=8) : void {
         ...
         while(_loc7_<=param5)
         {
            _loc8_=luqi*_loc7_/param5;
            _loc9_=luqi*(_loc7_-0.5)/param5;
      ...
      public static const muro:Array = [true,true,true,true];

      public static function secebeq(param1:int, param2:int, param3:int, param4:int, param5:int, param6:Array, param7:GraphicsPath) : void {
         var _loc8_:* = true;
         var _loc9_:* = false;
         if(param6[0]!=0)
         {
      ...
      public static function gon(param1:Number, param2:Number, param3:Number, param4:GraphicsPath) : void {
         var _loc5_:* = true;
         var _loc6_:* = false;
