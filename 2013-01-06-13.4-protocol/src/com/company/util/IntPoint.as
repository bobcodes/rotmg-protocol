...
{
[CLASS1385]   import flash.geom.Point;
   ...
   public class IntPoint extends Object
   {
      ...
      public static function rilyhi() : void {
         var _loc1_:UnitTest = new UnitTest();
         return;
      }

      public static function fosecygu(param1:Point) : IntPoint {
      ...
      public function tavupu(param1:int) : void {
         var _loc2_:* = false;
         var _loc3_:* = true;
         this.x_=param1;
         return;
      ...
      public function jife(param1:int) : void {
         var _loc2_:* = true;
         var _loc3_:* = false;
         this.y_=param1;
         return;
      ...
      public function kinukira(param1:IntPoint) : Boolean {
         var _loc2_:* = true;
         var _loc3_:* = false;
         return this.x_==param1.x_&&this.y_==param1.y_;
      }

      public function bidehus(param1:IntPoint) : int {
         var _loc4_:* = false;
         var _loc5_:* = true;
      ...
      public function nahypif(param1:IntPoint) : Number {
         var _loc4_:* = true;
         var _loc5_:* = false;
         var _loc2_:int = param1.x_-this.x_;
         var _loc3_:int = param1.y_-this.y_;
      ...
      public function hunapiz(param1:Point) : Number {
      ...
      public function kycazewu(param1:IntPoint) : int {
         var _loc4_:* = false;
         var _loc5_:* = true;
         var _loc2_:int = param1.x()-this.x_;
         var _loc3_:int = param1.y()-this.y_;
      ...
      public function transform(param1:Matrix) : IntPoint {
         var _loc2_:Point = param1.transformPoint(this.pirocihic());
...
[/CLASS]
}[CLASS1386]   import com.company.util.IntPoint;
