package gob
{
[CLASS200]   import natus.Hewoda;
   import com.company.assembleegameclient.parameters.Parameters;


   public class Cafiw extends Object implements Hewoda
   {
      public function Cafiw() {
         var _loc1_:* = false;
         var _loc2_:* = true;
         super();
         return;
      ...
      private const leryd:String = "<font color=\'#FFEE00\'>TESTING APP ENGINE, PRIVATE SERVER</font> #{VERSION}";
      ...
      public function cakavuz() : String {
         ...
         return this.leryd.replace("{VERSION}",_loc1_);
      }
