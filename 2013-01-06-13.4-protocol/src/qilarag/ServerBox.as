package qilarag
{
[CLASS1648]   import flash.display.Sprite;
   import pudev.Capitu;
   ...
   public class ServerBox extends Sprite
   {
      ...
      public function ServerBox(param1:Server) {
         ...
         this.nameText_=new Capitu().setSize(18).setColor(16777215).setBold(true);
         if(param1==null)
         {
            this.nameText_.setStringBuilder(new Zufi().setParams(Kefyfa.roka));
         }
         else
         {
            this.nameText_.setStringBuilder(new Javo(param1.name));
         }
         this.nameText_.filters=[new DropShadowFilter(0,0,0,1,8,8)];
         this.nameText_.x=18;
         this.nameText_.setVerticalAlign(Capitu.MIDDLE);
      ...
      private function piha(param1:Server) : void {
         var _loc3_:* = true;
         var _loc4_:* = false;
      ...
      private function makeStatusText(param1:uint, param2:String) : void {
         var _loc3_:* = false;
         var _loc4_:* = true;
         this.jepewuw=new Capitu().setSize(18).setColor(param1).setBold(true).setAutoSize(TextFieldAutoSize.CENTER);
         this.jepewuw.setStringBuilder(new Zufi().setParams(param2));
         this.jepewuw.filters=[new DropShadowFilter(0,0,0,1,8,8)];
         this.jepewuw.x=WIDTH/2+WIDTH/4;
         this.jepewuw.y=ServerBox.HEIGHT/2-this.nameText_.height/2;
