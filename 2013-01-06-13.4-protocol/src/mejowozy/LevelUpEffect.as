package mejowozy
{
[CLASS1410]   import com.company.assembleegameclient.objects.GameObject;
   import __AS3__.vec.Vector;


   public class LevelUpEffect extends Ryf
   {
      {
         var _loc1_:* = false;
         var _loc2_:* = true;
      ...
      private static const myco:int = 2000;
      ...
      override public function update(param1:int, param2:int) : Boolean {
         ...
         var _loc3_:Number = (param1-this.startTime_)/myco;
         if(_loc3_>=1)
         {
            this.loqig();
            return false;
         }
         this.wesy(this.parts1_,1,0,_loc3_);
         this.wesy(this.parts2_,1,Math.PI,_loc3_);
         return true;
      }

      private function loqig() : void {
         var _loc4_:* = false;
         var _loc5_:* = true;
      ...
      public function wesy(param1:Vector.<LevelUpParticle>, param2:Number, param3:Number, param4:Number) : void {
         var _loc10_:* = true;
         var _loc11_:* = false;
         var _loc5_:* = 0;
...
[/CLASS]
}[CLASS1411]   import mejowozy.Particle;
