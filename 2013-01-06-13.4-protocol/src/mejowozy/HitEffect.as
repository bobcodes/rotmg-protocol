package mejowozy
{
[CLASS1399]   import __AS3__.vec.Vector;


   public class HitEffect extends Ryf
   {
      ...
      override public function update(param1:int, param2:int) : Boolean {
         ...
         var _loc5_:* = 0;
         while(_loc5_<this.corap)
         {
            _loc6_=this.hove[int(this.hove.length*Math.random())];
...
[/CLASS]
}[CLASS1400]   import mejowozy.Particle;
