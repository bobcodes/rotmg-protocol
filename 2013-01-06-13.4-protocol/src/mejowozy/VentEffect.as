package mejowozy
{
[CLASS1692]   import com.company.assembleegameclient.objects.GameObject;
   import com.company.assembleegameclient.util.Deqipe;


   public class VentEffect extends Ryf
   {
      {
         var _loc1_:* = true;
         var _loc2_:* = false;
      ...
      private static const hal:int = 50;
      ...
      override public function update(param1:int, param2:int) : Boolean {
         ...
         x_=this.go_.x_;
         y_=this.go_.y_;
         var _loc3_:int = int(this.lastUpdate_/hal);
         while(_loc3_<int(param1/hal))
         {
            _loc4_=_loc3_*hal;
            _loc5_=Deqipe.wesijah(VentParticle) as VentParticle;
...
[/CLASS]
}[CLASS1693]   import mejowozy.Particle;
   import com.company.assembleegameclient.util.Deqipe;
