package mejowozy
{
[CLASS1695]   import com.company.assembleegameclient.objects.GameObject;
   import com.company.assembleegameclient.util.Deqipe;


   public class FountainEffect extends Ryf
   {
      ...
      override public function update(param1:int, param2:int) : Boolean {
         ...
         {
            _loc4_=_loc3_*50;
            _loc5_=Deqipe.wesijah(FountainParticle) as FountainParticle;
...
[/CLASS]
}[CLASS1696]   import mejowozy.Particle;
