package mejowozy
{
[CLASS1405]   import __AS3__.vec.Vector;


   public class ExplosionEffect extends Ryf
   {
      ...
      public var hove:Vector.<uint>;

      public var corap:int;
      ...
      override public function update(param1:int, param2:int) : Boolean {
         ...
         if(this.hove.length==0)
         {
            return false;
         }
         var _loc3_:* = 0;
         while(_loc3_<this.corap)
         {
            _loc4_=this.hove[int(this.hove.length*Math.random())];
...
[/CLASS]
}[CLASS1406]   import mejowozy.Particle;
