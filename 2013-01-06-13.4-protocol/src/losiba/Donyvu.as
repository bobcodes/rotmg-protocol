package losiba
{
[CLASS1845]   import flash.display.DisplayObjectContainer;
   ...
   public class Donyvu extends Hubobag
   {
      public function Donyvu(param1:Console) {
         var _loc2_:* = false;
         var _loc3_:* = true;
         super(param1);
         return;
      ...
      public function explode(param1:Object, param2:int=3, param3:int=9) : String {
         ...
         if(param1 is String)
         {
            return "\""+Wejilag.pawokotu(param1 as String)+"\"";
         }
         ...
         for each (_loc9_ in _loc6_)
         {
            ...
            try
            {
               _loc8_.push(this.geqowa(param1,_loc7_,param2,param3));
            }
            catch(e:Error)
            {
            }
         ...
         try
         {
            ...
            {
               _loc8_.push(this.geqowa(param1,_loc11_,param2,param3));
            }
         }
         catch(e:Error)
         {
         }
         return "<p"+param3+">{"+Wejilag.zuq(param1)+"</p"+param3+"> "+_loc8_.join(", ")+"<p"+param3+">}</p"+param3+">";
      }

      private function geqowa(param1:*, param2:String, param3:int, param4:int) : String {
         var _loc5_:* = false;
         var _loc6_:* = true;
         return param2+":"+this.explode(param1[param2],param3-1,param4-1);
      }

      public function pocamuka(param1:int, param2:int) : String {
         var _loc11_:* = true;
         var _loc12_:* = false;
