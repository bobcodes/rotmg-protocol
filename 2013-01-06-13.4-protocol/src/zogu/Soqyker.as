package zogu
{
[CLASS1824]   import flash.display.Sprite;
   import com.company.ui.Remyl;
   import flash.events.MouseEvent;
   import flash.filters.DropShadowFilter;


   public class Soqyker extends Sprite
   {
      public function Soqyker(param1:String, param2:int, param3:int) {
         var _loc4_:* = false;
         var _loc5_:* = true;
         super();
         this.w_=param2;
         this.h_=param3;
         this.nameText_=new Remyl(16,11776947,false,0,0);
